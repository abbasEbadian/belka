...
<h5> اعتبار سنجی فعال :  {user.choices_2fa != "google"  ? "تلفن همراه" : "کد دو مرحله ای گوگل"}</h5>
                        ...
                        <ChangeContent>
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    type={
                                        !showPasswordThree ? "password" : "text"
                                    }
                                />
                                <svg
                                    className="show-pass"
                                    onClick={() => {
                                        setShowPasswordThree(
                                            !showPasswordThree
                                        );
                                    }}
                                    xmlns="http://www.w3.org/2000/svg"
