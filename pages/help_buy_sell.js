...
export default function Fee() {
    return (
        <Main>
            <Head>
                <title>صرافی متاورس | راهنمای خرید و فروش</title>
            ...
            <SMain>
                ...
                <div style={{color: "white"}}>
                    ...
                    <p>در ادامه مراحل لازم برای خرید یا فروش رمزارز در صرافی متاورس می&zwnj;پردازیم. فرض کنید که قصد داریم از این صرافی مقداری بیت کوین خریداری کنیم. در صفحه اصلی گزینه (خرید و فروش) را انتخاب کنید. از میان لیست ارزها بعنوان مثال بیت کوین را انتخاب کنید.</p>
