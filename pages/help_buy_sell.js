...
Fee.title = `صرافی ${SETTINGS.WEBSITE_NAME} | راهنمای خرید و فروش`
export default function Fee() {
    return (
        <Main>
            <LandingHeaders page="help_buy_sell" />
            <SMain>
                <SContent>
                <div style={{color: "white"}}>
                    <h2>آموزش خرید و فروش ارز دیجیتال در صرافی {SETTINGS.WEBSITE_NAME}</h2>

                    <p>در ادامه مراحل لازم برای خرید یا فروش رمزارز در صرافی {SETTINGS.WEBSITE_NAME} می&zwnj;پردازیم. فرض کنید که قصد داریم از این صرافی مقداری بیت کوین خریداری کنیم. در صفحه اصلی گزینه (خرید و فروش) را انتخاب کنید. از میان لیست ارزها بعنوان مثال بیت کوین را انتخاب کنید.</p>
