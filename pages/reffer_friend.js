...
Fee.title = `صرافی ${SETTINGS.WEBSITE_NAME} | دعوت از دوستان`
        ...
        <Main>
            ...
            <SMain>
                ...
                <div style={{color: "white"}}>
                    ...
                    <p><span>چگونه دوستانمان را به {SETTINGS.WEBSITE_NAME} دعوت کنیم؟</span></p>
                    ...
                    <ul>
                        <li>در حال حاضر ۳۰٪ از کارمزد تمامی معاملات انجام شده توسط کاربر معرفی شده در بازارهای {SETTINGS.WEBSITE_NAME} به فرد ارجاع دهنده تعلق می&zwnj;گیرد</li>
                        <li>برای هر معامله دقیقاً ۳۰٪ ارزش معادل ریالی کارمزد کسر شده از طرف دعوت شده به فرد ارجاع دهنده تعلق می&zwnj;گیرد. مبلغ کارمزد بر اساس درصد کارمزد کاربر دعوت شده و ارزش معادل ریالی کارمزد در لحظه انجام معامله با دقت یک ریال محاسبه می&zwnj;شود. در بازارهای تتر قیمت خرید لحظه&zwnj;ای استاندارد تتر در {SETTINGS.WEBSITE_NAME} برای تعیین ارزش ریالی کارمزد لحاظ می&zwnj;شود<span dir="LTR">.</span></li>
                        <li>هدیه&zwnj;ی ارجاع به صورت تجمیعی پس از رسیدن مجموع مبالغ آن به حد نصاب ده هزار تومان به حساب کیف پول ریال معرف در {SETTINGS.WEBSITE_NAME} &nbsp;واریز می&zwnj;شود. در صورت کمتر بودن مجموع مبالغ از این حد نصاب، مجموع مبالغ پس از گذشت هفت روز به حساب معرف واریز می&zwnj;شود<span dir="LTR">.</span></li>
                        ...
                        <li>فرد معرفی شده می&zwnj;تواند حداکثر تا ۲۴ ساعت پس از زمان ثبت&zwnj;نام با ورود به سامانه کد معرف خود را ثبت نماید. مسئولیت اطمینان از ثبت معرف برای کاربران دعوت شده صرفاً بر عهده&zwnj;ی معرف بوده و {SETTINGS.WEBSITE_NAME} مسئولیتی در قبال عدم ورود کد معرف توسط فرد معرفی شده ندارد<span dir="LTR">.</span></li>
                        ...
                        <li>{SETTINGS.WEBSITE_NAME} این حق را برای خود محفوظ می&zwnj;داند که هر زمان در صورت صلاحدید قوانین طرح معرفی دوستان را تغییر دهد</li>
                    </ul>
                </div>
