    ...
    return (
        <Main>
            ...
            <FeeMain>
                <FeeContent>
                <div>
                    <p>کارمزد و ببرسی صرافی متاورس</p>
                    <p><strong>صرافی متاورس؛کارمزد، بررسی قیمت و ویژگی صرافی ارز دیجیتال متاورس</strong></p>
                    <p>صرافی متاورس ، یکی از صرافی های فعال در زمینه ارز دیجیتال ، در کشور ایران می باشد ،هدف ما ایجاد بستری شفاف برای معاملات شماست،به همین منظورتمامی هزینه ها و کارمزد های بستر متاورس را بصورت شفاف و دقیق به اطلاع کاربران می رسانیم.</p>
                    <p>&nbsp;ثبت&zwnj;نام و استفاده از سامانه&zwnj;ی متاورس کاملا رایگان می&zwnj;باشد و تنها طبق توضیحات مندرج در این صفحه، از برخی معاملات و اعمال مالی انجام شده در سامانه هزینه&zwnj;ی کمی به عنوان کارمزد کسر می&zwnj;شود</p>
                    <p>کارمزد معاملات</p>
                    <p>کارمزد معاملات در سامانه متاورس بصورت درصد از مبلغ کل معامله است و محاسبه&zwnj;ی آن بر اساس ملاحظات زیر صورت می&zwnj;گیرد. لازم به توضیح است که کسر کارمزد از معاملات باعث جلوگیری از ثبت معاملات صوری و مکرر خواهد شد و شرایط مطلوب&zwnj;تری را در بازار برای تمامی کاربران ایجاد می&zwnj;کند.</p>
                    ...
                    <ul>
                        ...
                        <li>در هنگام ثبت معاملات از طریق سامانه&zwnj;ی متاورس ، مبلغ دقیق کارمزد برای آن معامله برای شما نمایش داده خواهد شد.</li>
                        <li>لازم به ذکر است در واریز رمزارز باید دقت زیادی داشته باشید،&zwnj; همچنین اطمینان حاصل کنید که اطلاعات کافی درباره شبکه رمزارز ها داشته و مبدا و مقصد مورد نظر از آن پشتیبانی میکنند. در صورت هر گونه اشتباه در ثبت اطلاعات یا شبکه&zwnj;ای که متاورس از آن پشتیبانی نمی&zwnj;کند ممکن است دارایی شما از بین رفته و عملا بازیابی آن غیر ممکن بوده ومتاورس هیچ ضمانتی درباره آن ارائه نمیدهد.&nbsp;</li>
                    </ul>
                    <p><strong><u>باتوجه به سیکل&zwnj;های تسویه پایا در کشور بنا بر ابلاغیه بانک مرکزی، زمان&zwnj;های تسویه ریالی متاورس به شرح زیر است:</u></strong></p>
                    <ul>
                    ...
                    <p><strong><u>ویژگی های صرافی متاورس</u></strong></p>
                    <p>&nbsp;</p>
                    ...
                    <p><strong>وبلاگ آموزشی : دارای پلتفرم آموزشی آکادمی متاورس آنلاین/ حضوری</strong></p>
                    ...
                    <p>توضیحات صرافی:&nbsp;صرافی متاورس&nbsp; metavers را میتوان یکی از پرسرعت ترین صرافی ارز دیجیتال در ایران دانست؛ این صرافی از تعداد زیادی از رمز ارزها (بیش از 350 ارز) پشتیبانی می کند و امکان خرید و فروش انلاین به ساده ترین و سریع ترین حالت ممکن وجود دارد و امکان معامله حضوری هم امکان پذیر است.متاورس با داشتن تنوع ارزها و پشتیبانی 24 ساعته و ارائه خدمات وسهولت برای کاربران یکی از صرافی های مطرح محسوب می شود .</p>
                    <p><strong>نقد و بررسی صرافی متاورس</strong><strong> (metaverse)</strong></p>
                    <p>صرافی متاورس یا metaverse &nbsp;از&nbsp;<u> پاییز سال 1400 </u>&nbsp;فعالیت خود را بصورت رسمی آغاز کرده است. صرافی رمز ارز متاورس از <u>350 </u>&nbsp;ارزدیجیتال در مارکت تومانی با کارمزد&nbsp;<u>0.2%</u>&nbsp;پشتیبانی می کند.&nbsp; پروسه احراز هویت متاورس حداکثر&nbsp;<u>30 </u><u>دقیقه</u>&nbsp;زمان می برد. لازم به ذکر است حداقل مقدار قابل خرید در این صرافی&nbsp;<strong>400هزار تومان</strong>&nbsp;و حداقل مقدار قابل فروش&nbsp;<strong>بدون محدودیت</strong>&nbsp;می باشد.<br />از نکات&nbsp;مثبت&nbsp;این صرافی پشتیبانی از کیف پول اختصاصی، سیستم درآمد زایی، ورود دو مرحله ای، راه های ارتباطی چت&nbsp;,&nbsp;تلفن&nbsp;,&nbsp;حضوری و اپلیکیشن android و پایه پولی تتر&nbsp;,&nbsp;تومان و شبکه اتریوم&nbsp;,&nbsp;بایننس&nbsp;,&nbsp;اسمارت چین&nbsp;,&nbsp;ترون می باشد.</p>
                    <p>&nbsp;</p>
                    ...
                    <p>در این راستا،&nbsp;صرافی&nbsp;های ارز دیجیتال ،&nbsp;در ایران، راه اندازی شد که&nbsp;صرافی متاورس، به نشانی اینترنتی&nbsp;metavers-ex.com، یکی از آن ها است. این&nbsp;صرافی،&nbsp;توانسته است، استفاده از فرصت های سرمایه گذاری در بازار کریپتوکارنسی را برای کاربران ایرانی، تسهیل نماید.</p>
                    <p>باتوجه به اهمیت&nbsp;صرافی متاورس،&nbsp;برای کاربران ایرانی فعال در زمینه ارز های دیجیتالی، در ادامه، در رابطه با معرفی&nbsp;صرافی متاورس ،&nbsp;ورود به&nbsp;سایت متاورس، به نشانی&nbsp;metavers-ex.com،&nbsp;ثبت نام&nbsp;و نحوه&nbsp;احراز هویت&nbsp;در این&nbsp;صرافی، ورود به حساب کاربری&nbsp;متاورس، آموزش خرید و فروش در این&nbsp;سایت، دانلود اپلیکیشن آن و همچنین، دیگر خدمات این&nbsp;صرافی&nbsp;رمز ارز ها، مطالبی آورده شده است.&nbsp;</p>
                    <p><br />جهت&nbsp;<strong>ورود</strong>&nbsp; به صرافی متاورس &nbsp;یا&nbsp;<strong>ثبت نام</strong>&nbsp;در متاورس رو دکمه ورود / ثبت نام بالای صفحه کلیک کنید.</p>
                </div>
                <img
