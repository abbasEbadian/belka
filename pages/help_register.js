...
export default function Fee() {
    return (
        <Main>
            <Head>
                <title>صرافی متاورس | راهنمای ثبت نام</title>
            </Head>
            <LandingHeaders page="help_register" />
            <SMain>
                <SContent>
                <div style={{color: "white"}}>
                    <h2>آموزش ثبت نام و استفاده از صرافی متاورس</h2>

                    <p>برای ورود به صرافی متاورس و ثبت نام اولیه تنها کافی است که شماره موبایل خود را وارد کرده و با استفاده از کد ارسالی به شماره موبایل واردشده، آن را تأیید نمایید. با گذراندن این مرحله می&zwnj;توانید از گزینه خرید و فروش فوری استفاده کنید<span dir="LTR">.</span>(عکس)</p>

                    <p>همچنین با استفاده از طرح معرفی دوستان در صرافی متاورس، می&zwnj;توانید تا 30 درصد از کارمزد معاملات افراد زیرمجموعه خود را از آن خود کنید<span dir="LTR">.</span></p>
                    ...
                    <p>احراز هویت درمتاورس</p>

                    <p>احتمالاً یکی از نقاط قوت صرافی متاورس احراز هویت سریع و آسان آن است که طبق دستورالعمل زیر در سه مرحله صورت می&zwnj;گیرد<span dir="LTR">:</span></p>
